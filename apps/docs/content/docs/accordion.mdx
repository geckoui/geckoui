...
That animates to the content's real height with nothing measured in JavaScript, and no
`max-height` guess that clips tall content or drags on short content. It is also why closed
panels stay mounted by default — there is nothing to collapse otherwise.
