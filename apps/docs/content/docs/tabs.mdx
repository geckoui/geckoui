...
import { TabsBasicExample, TabsVariantsExample, TabsSizesExample, TabsFullWidthExample, TabsVerticalExample, TabsRichLabelExample, TabsIconExample, TabsScrollableExample, TabsControlledExample, TabsKeepMountedExample, TabsNavExample } from '@/components/examples/tabs-examples';
...
<Tabs defaultValue="one" variant="underline">
  <Tab value="one" label="One">First panel</Tab>
  <Tab value="two" label="Two">Second panel</Tab>
  <Tab value="three" label="Three">Third panel</Tab>
</Tabs>
```
...
<Tabs defaultValue="one" variant="segmented" size="sm">
  <Tab value="one" label="Small">First panel</Tab>
  <Tab value="two" label="Another">Second panel</Tab>
</Tabs>
```
...
<Tabs defaultValue="overview" fullWidth>
  ...
  <Tab value="activity" label="Activity">Activity panel</Tab>
...
<Tabs defaultValue="general" orientation="vertical" variant="soft">
  <Tab value="general" label="General">General panel</Tab>
  <Tab value="security" label="Security">Security panel</Tab>
  <Tab value="advanced" label="Advanced">Advanced panel</Tab>
</Tabs>
```
...
There is no icon prop. An icon is part of the `label`, like anything else.
...
```tsx
import { Tabs, Tab, Badge } from '@geckoui/geckoui';
...
<Tabs defaultValue="july">
  {MONTHS.map((month) => (
    <Tab key={month} value={month.toLowerCase()} label={month}>
...
<Tabs defaultValue="form" keepMounted>
  ...
  <Tab value="other" label="Other">Other panel</Tab>
</Tabs>
