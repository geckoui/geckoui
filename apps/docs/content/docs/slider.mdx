...
import { SliderBasicExample, SliderChangeEndExample, SliderMarksExample, SliderRangeExample, SliderThumbExample, SliderColorsExample, SliderSizesExample, SliderStepExample } from '@/components/examples/slider-examples';
