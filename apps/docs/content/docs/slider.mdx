...
import { SliderBasicExample, SliderChangeEndExample, SliderMarksExample, SliderRangeExample, SliderThumbExample, SliderThumbIconExample, SliderColorsExample, SliderSizesExample, SliderStepExample } from '@/components/examples/slider-examples';
...
The component's own circle is dropped when you do, so there is nothing left behind whatever you draw — the colour, the shape and the size are all yours.
