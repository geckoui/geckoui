...
- `GeckoUISelectOption` - Base option element
  ...
  - `data-focused` - Applied when focused
...
- [Basic Usage](/v1/docs/select) - Introduction to Select
- [Filterable](/v1/docs/select/filterable) - How filtering works with custom content
- [SelectTrigger](/v1/docs/select/select-trigger) - Custom trigger components
- [Multiple Selection](/v1/docs/select/multiple) - Multi-select with custom options
