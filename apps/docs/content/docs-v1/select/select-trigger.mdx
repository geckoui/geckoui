...
import { Select, SelectOption, SelectTrigger, Input, Button } from '@geckoui/geckoui';
...
- [Multiple Selection](/v1/docs/select/multiple) - Multi-select patterns
- [Filterable](/v1/docs/select/filterable) - Built-in search without custom trigger
- [SelectOption](/v1/docs/select/select-option) - Customize option display
- [Advanced](/v1/docs/select/advanced) - Programmatic control with useSelect hook
