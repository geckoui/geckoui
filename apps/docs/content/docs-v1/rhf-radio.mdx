...
Extends all props from [Radio](/v1/docs/radio) component plus:
...
RHFRadio doesn't apply error styling directly. Use [RHFInputGroup](/v1/docs/rhf-input-group) to display errors for the group:
...
- Inherits all accessibility features from [Radio](/v1/docs/radio) component
...
- [Radio](/v1/docs/radio) - Base radio component
- [RHFCheckbox](/v1/docs/rhf-checkbox) - Multi-select checkboxes
