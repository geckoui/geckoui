...
- `GeckoUIOTPInput[data-state="enabled"]` - Applied when not disabled
- `GeckoUIOTPInput[data-state="disabled"]` - Applied when disabled
...
- [RHFOTPInput](/v1/docs/rhf-otp-input) - React Hook Form integration
