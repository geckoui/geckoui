...
Extends all props from [Switch](/v1/docs/switch) component plus:
...
RHFSwitch doesn't apply error styling directly. Use [RHFInputGroup](/v1/docs/rhf-input-group) to display errors:
...
- Inherits all accessibility features from [Switch](/v1/docs/switch) component
...
- [Switch](/v1/docs/switch) - Base switch component
- [RHFCheckbox](/v1/docs/rhf-checkbox) - Checkbox component
- [RHFRadio](/v1/docs/rhf-radio) - Radio button component
