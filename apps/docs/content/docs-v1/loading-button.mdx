...
- `data-loading` - Applied during loading state

Variant, color, and size styling are handled by the underlying [Button](/v1/docs/button) component via its own `data-*` attributes.
...
- [Button](/v1/docs/button) - Base button component
- [Spinner](/v1/docs/spinner) - Loading spinner component
