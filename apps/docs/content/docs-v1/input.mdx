...
The component uses a base class with data attributes for states:

- `GeckoUIInput` - Main container
- `GeckoUIInput[data-state="enabled"]` - Applied when not disabled
- `GeckoUIInput[data-state="disabled"]` - Applied when disabled
- `GeckoUIInput[data-readonly]` - Applied when read-only
...
- [Textarea](/v1/docs/textarea) - Multi-line text input
- [Label](/v1/docs/label) - Form labels with tooltip support
- [InputError](/v1/docs/input-error) - Error message display
- [RHFInput](/v1/docs/rhf-input) - React Hook Form integration
