...
Extends all props from [Textarea](/v1/docs/textarea) component plus:
...
Use [RHFInputGroup](/v1/docs/rhf-input-group) component for label + textarea + error layout:
...
- Inherits all accessibility features from [Textarea](/v1/docs/textarea) component
...
- [Textarea](/v1/docs/textarea) - Base textarea component
- [RHFInput](/v1/docs/rhf-input) - Single-line text input
