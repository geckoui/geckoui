...
Extends all props from [DateInput](/v1/docs/date-input) component plus:
...
Use [RHFInputGroup](/v1/docs/rhf-input-group) component for label + input + error layout:
...
- Inherits all accessibility features from [DateInput](/v1/docs/date-input) component
...
- [DateInput](/v1/docs/date-input) - Base date input component
- [RHFInputGroup](/v1/docs/rhf-input-group) - Input group wrapper with label and error
