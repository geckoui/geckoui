...
Extends all props from [Label](/v1/docs/label) component plus:
...
3. **Renders error messages** - Automatically passes these to [RHFError](/v1/docs/rhf-error) component to display validation errors
...
For multiple inputs with individual error messages, use [RHFError](/v1/docs/rhf-error) manually:
...
2. **Custom layouts** - Use [Label](/v1/docs/label) and [RHFError](/v1/docs/rhf-error) separately for complex layouts
...
- Inherits all accessibility features from [Label](/v1/docs/label) component
...
- [RHFError](/v1/docs/rhf-error) - Error message display component
- [RHFInput](/v1/docs/rhf-input) - Text input with React Hook Form
- [RHFTextarea](/v1/docs/rhf-textarea) - Multi-line text input
- [Label](/v1/docs/label) - Base label component
