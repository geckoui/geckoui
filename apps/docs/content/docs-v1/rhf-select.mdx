...
Extends all props from [Select](/v1/docs/select) component plus:
...
Use [RHFInputGroup](/v1/docs/rhf-input-group) component for label + select + error layout:
...
- [Select](/v1/docs/select) - Base select component
- [SelectOption](/v1/docs/select/select-option) - Individual option component
- [RHFInputGroup](/v1/docs/rhf-input-group) - Label and error wrapper
