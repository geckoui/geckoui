...
Extends all props from [DateRangeInput](/v1/docs/date-range-input) component plus:
...
Error messages can be displayed using the [RHFError](/v1/docs/rhf-error) component or [RHFInputGroup](/v1/docs/rhf-input-group).

## Related Components

- [DateRangeInput](/v1/docs/date-range-input) - Base date range input component
- [RHFDateInput](/v1/docs/rhf-date-input) - Single date input with RHF
- [RHFInputGroup](/v1/docs/rhf-input-group) - Form field wrapper with label and error
